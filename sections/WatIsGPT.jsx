    ...
    <div className="relative z-10">
      <div className="container">
        <div className="bg-[#042C54] flex flex-col gap-[70px] md:gap-[90px] overflow-hidden sec-shadow p-10 md:p-16">
          ...
          <div className="flex flex-col text-center justify-between z-10 gap-[50px] md:gap-[100px] w-full md:flex-row md:text-start">
            <h1 className="spec text-[22px] md:text-[24px] basis-[40%] before:left-[50%] before:translate-x-[-50%] before:md:left-0 before:md:translate-x-0">
              What is GPT-3
            </h1>
          ...
          <div className="flex flex-col text-center justify-between z-10 md:flex-row md:text-start">
